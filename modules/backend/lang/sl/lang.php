...
return [
    ...
    'field' => [
        'invalid_type' => 'Uporabljen neveljaven tip polja :type.',
        'options_method_not_exists' => "Razred modela :model mora definirati metodo :method(), ki vrne opcije za polje obrazca ':field'."
    ],
    'widget' => [
        'not_registered' => "Ime razreda pripomočka ':name' ni bilo registrirano",
        'not_bound' => "Ime razreda pripomočka ':name' ni bilo vezano na krmilnik"
    ],
    'page' => [
        'untitled' => 'Brez naslova',
        'access_denied' => [
            'label' => 'Dostop zavrnjen',
            'help' => "Za ogled te strani nimate ustreznih pravic.",
            'cms_link' => 'Vrnite se na ozadje'
        ],
        'no_database' => [
            'label' => 'Manjka podatkovna baza',
            'help' => "Za dostop do ozadja je potrebna podatkovna baza. Preverite, da je podatkovna baza nastavljena in migrirana preden ponovno poskusite.",
            'cms_link' => 'Vrnite se nazaj na domačo stran'
        ],
        'invalid_token' => [
            'label' => 'Neveljaven varnostni žeton'
        ]
    ],
    'partial' => [
        'not_found_name' => "Začasno ime ':name' ni najdeno."
    ],
    'account' => [
        'sign_out' => 'Odjava',
        'login' => 'Prijava',
        'reset' => 'Ponastavitev',
        'restore' => 'Povrnitev',
        'login_placeholder' => 'prijava',
        'password_placeholder' => 'geslo',
        'forgot_password' => 'Pozabili vaše geslo?',
        'enter_email' => 'Vnesite vašo e-pošto',
        'enter_login' => 'Vnesite vašo prijavo',
    ...
    'import_export' => [
        ...
        'behavior_missing_uselist_error' => 'Implementirati morate obnašanje krmilnika ListController z omogočeno opcijo izvoza "useList".',
        'missing_model_class_error' => 'Prosimo, določite lastnost modelClass za :type',
        'missing_column_id_error' => 'Manjka identifikator stolpca',
        'unknown_column_error' => 'Neznan stolpec',
        'encoding_not_supported_error' => 'Kodiranje izvorne datoteke ni prepoznano. Prosimo, izberite opcijo formata datoteke po meri z ustreznim kodiranjem, da uvozite vašo datoteko.',
