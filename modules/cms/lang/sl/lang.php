...
return [
    'cms_object' => [
        'invalid_file' => 'Neveljavno ime datoteke: :name. Imena datotek lahko vsebujejo samo alfanumerične simbole, podčrtaje, pomišljaje in pike. Nekateri primeri ustreznih imen datotek: page.htm, page, subdirectory/page',
        'invalid_property' => "Lastnosti ':name' ni mogoče nastaviti",
